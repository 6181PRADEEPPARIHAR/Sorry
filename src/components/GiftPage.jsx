              ...
              <AnimatePresence>
                {showSurprise && (
                  ...
                  >
                    ...
                    >
                      Just like that my Friendship and My Love for you will never wilt.I am always there for you and with you jii. I promise to cherish you every single day, and never take your beautiful heart for granted again.💖
                    </motion.p>
                    <motion.p
                      initial={{ opacity: 0, y: 15 }}
                      animate={{ opacity: 1, y: 0 }}
                    ...
                    >
                      You mean everything to me jiii💕✨
                    </motion.p>
                  </motion.div>
                )}
              </AnimatePresence>
